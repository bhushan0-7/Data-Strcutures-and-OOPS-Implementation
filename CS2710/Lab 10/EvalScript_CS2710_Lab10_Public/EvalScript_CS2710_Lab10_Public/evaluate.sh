...
# Configuration
LAB_NO=10    # Change this to the appropriate lab number
# TIME_LIMIT="5"  # Set this to the time limit for each test case execution in seconds, or leave empty for no limit
